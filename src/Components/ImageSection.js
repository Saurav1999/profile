    ...
    return (
        <div className="ImageSection">
            ...
            <div className="about-info">
                <h4>I am<span> Saurav Singh</span></h4>
                ...
                <a href="https://drive.google.com/file/d/1Jq2joblU7BSny_nX9QLqscXYguYhfCKT/view?usp=sharing"><button className="btn">Resume</button></a>
            </div>
        </div>
    )
}
